...
class GRUED(Algorithm, PyTorchUtils):
    def __init__(self, name: str = 'GRU-ED', num_epochs: int = 30, batch_size: int = 16, lr: float = 1e-5,
                 hidden_size: int = 40, sequence_length: int = 30, step: int = 30, train_gaussian_percentage: float = 0.20,
...
#            print("hello",len(train_loader))
            global_error.append(sumerr/len(train_loader))
