...
class LSTMED(Algorithm, PyTorchUtils):
    def __init__(self, name: str = 'LSTM-ED', num_epochs: int = 1, batch_size: int = 10, lr: float = 1e-3,
                 hidden_size: int = 5, sequence_length: int = 672, window: int = 500, train_gaussian_percentage: float = 0.25,
